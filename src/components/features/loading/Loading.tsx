...
const LoadingClient = () => {
	return (
		<div className="fixed inset-0 z-10 flex h-full w-full flex-col items-center justify-center bg-white">
			<Image
				className={twMerge('left-0 top-0 h-32 w-auto scale-150 transition-transform duration-300')}
				src={LogoVietcom}
