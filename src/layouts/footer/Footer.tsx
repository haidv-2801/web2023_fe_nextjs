...
export default function Footer() {
	...
	return (
		<footer className="mt-auto bg-[#002155]" aria-labelledby="footer-heading">
			<h2 id="footer-heading" className="sr-only">
				Footer
			</h2>
			<div className="mx-auto border-t px-6 pb-8 pt-16 text-white sm:pt-24 lg:px-8 lg:pt-32">
				<div className="mx-auto flex max-w-7xl flex-col flex-wrap gap-6 sm:flex-row	md:flex-nowrap">
